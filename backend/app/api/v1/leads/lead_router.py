...
def get_lead_service(
    ...
    All repositories and automation services use the same
    request-scoped database session.

    This guarantees that lead creation and the activity
    generated by LEAD_CREATED automation participate in
